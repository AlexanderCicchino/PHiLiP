...
/** The mapping for the 2D and 3D grids follows from
 *  Cicchino, Alexander, et al. "Provably Stable Flux Reconstruction High-Order Methods on Curvilinear Elements.".
 *  The 2D is Eq. (66), and the 3D is Eq. (64).
*/
