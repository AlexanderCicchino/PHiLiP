...
compute_mean_pressure(const std::array<real,nstate> &conservative_soln1,
                      const std::array<real,nstate> &conservative_soln2) const
{
    const real pressure_1 = compute_pressure<real>(conservative_soln1);
    const real pressure_2 = compute_pressure<real>(conservative_soln2);
...
compute_mean_velocities(const std::array<real,nstate> &conservative_soln1,
                        const std::array<real,nstate> &conservative_soln2) const
{
    const dealii::Tensor<1,dim,real> vel_1 = compute_velocities<real>(conservative_soln1);
    const dealii::Tensor<1,dim,real> vel_2 = compute_velocities<real>(conservative_soln2);
