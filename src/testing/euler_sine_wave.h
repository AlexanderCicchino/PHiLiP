#ifndef __EULER_SINE_WAVE_H__
#define __EULER_SINE_WAVE_H__
...
class EulerSineWave : public TestsBase
{
public:
    /// Constructor.
    /** Simply calls the TestsBase constructor to set its parameters = parameters_input
     * */
    EulerSineWave(const Parameters::AllParameters *const parameters_input);
