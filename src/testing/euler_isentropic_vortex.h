#ifndef __EULER_ISENTROPIC_VORTEX_H__
#define __EULER_ISENTROPIC_VORTEX_H__
...
class EulerIsentropicVortex : public TestsBase
{
public:
    /// Constructor.
    /** Simply calls the TestsBase constructor to set its parameters = parameters_input
     * */
    EulerIsentropicVortex(const Parameters::AllParameters *const parameters_input);
...
private:
    ...
    /// Solves in time.
    void solve(std::shared_ptr <dealii::parallel::distributed::Triangulation<dim>> &grid,
