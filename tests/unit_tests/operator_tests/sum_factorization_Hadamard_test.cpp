...
//        pcout<<"The first method"<<std::endl;
//        for(unsigned int iquad=0; iquad<n_quad_pts; iquad++){
//        for(unsigned int iquad2=0; iquad2<n_quad_pts; iquad2++){
//            printf(" %g ",sol_dim[iquad][iquad2]);
//        }printf("\n");
//        }
//        printf("\n");
//        printf("\n");
//        pcout<<"The second method"<<std::endl;
//        for(unsigned int iquad=0; iquad<n_quad_pts; iquad++){
//        for(unsigned int iquad2=0; iquad2<n_quad_pts; iquad2++){
//            printf(" %g ",sol_1D[iquad][iquad2]);
//        }printf("\n");
//        }
//        printf("\n");
//        printf("\n");
    ...
    pcout<<"Normal operation A*u  | Slope |  "<<"Sum factorization | Slope "<<std::endl;
    for(unsigned int i=poly_min+1; i<poly_max; i++){
        pcout<<(float)time_diff_dir2[i]/CLOCKS_PER_SEC<<" "<<std::log(((float)time_diff_dir2[i]/CLOCKS_PER_SEC) / ((float)time_diff_dir2[i-1]/CLOCKS_PER_SEC))
                        / std::log((double)((i)/(i-1.0)))<<" "<<
    ...
    if(dim==3){
        ...
        pcout<<"Normal operation A*u  | Slope |  "<<"Sum factorization | Slope "<<std::endl;
        for(unsigned int i=poly_min+1; i<poly_max; i++){
            pcout<<(float)time_diff_dir3[i]/CLOCKS_PER_SEC<<" "<<std::log(((float)time_diff_dir3[i]/CLOCKS_PER_SEC) / ((float)time_diff_dir3[i-1]/CLOCKS_PER_SEC))
                            / std::log((double)((i)/(i-1.0)))<<" "<<
